  ...
  def extract(base_pt:String, source_name:String, feat_name:String, week_id:Int, interval:Int ): Unit ={
    ...
    val datas = data.map{
      ...
      group =>
        ...
        val feat: (Array[Int],Array[Int],Array[Int],Array[Double], Array[Double]) = feats(uid)
        (uid, vid, feat)
    }.groupBy( _._1 ).map {
    group =>
      val uid = group._1
      val values = toMap[ (Array[Int],Array[Int],Array[Int],Array[Double], Array[Double]) ](group._2)
      (uid,values)
    }


    val path = base_pt + "/" + feat_name
    print[ (Array[Int],Array[Int],Array[Int],Array[Double], Array[Double]) ](
